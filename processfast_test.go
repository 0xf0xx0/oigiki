...
func TestFastEmptyColorStack(t *testing.T) {
	str := "{/bg}{/fg}{/blue}"
	EXPECTED := "\x1b[0m"
	log(t, str, EXPECTED, false)
}

func TestFastResetEdgeCase(t *testing.T) {
...
func TestFastUnsetEdge(t *testing.T) {
...
func TestFastRedundantTag(t *testing.T) {
...
func TestFastNoColor(t *testing.T) {
	oigiki.NoColor = true
...
func FuzzFastTagging(f *testing.F) {
	testcases := []string{
